...
public class VolumeClientAc extends BaseDeviceCapacityAc_2 {

    @Override
    public int getViewKey() {
        return ViewKeys.VolumeClientAc;
    }
    ...
    public void setMainView() {
        ...
        String names[]=new String[]{"++","最大","--","最小"};
        int keys[]=new int[]{Volume.VolumeParameter.Type_addition,
                Volume.VolumeParameter.Type_addition_max,
                Volume.VolumeParameter.Type_subtraction,
                Volume.VolumeParameter.Type_subtraction_mid,
              };
    ...
    public MidMessageOrder_2 getCmdForChange(int changeKey) {
        DeviceCapacityInParameter mDeviceCapacityParameter = new Volume.VolumeParameter(changeKey);
