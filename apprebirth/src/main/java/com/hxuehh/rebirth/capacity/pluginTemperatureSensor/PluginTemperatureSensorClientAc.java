...
public class PluginTemperatureSensorClientAc extends BaseDeviceCapacityAc_2 {

    @Override
    public int getViewKey() {
        return ViewKeys.PluginTemperatureSensorClientAc;
    }
    ...
    public MidMessageOrder_2 getCmdForChange(int changeKey) {
        ...
        DeviceCapacityInParameter mDeviceCapacityParameter = new PluginTemperatureSensor.PluginTemperatureSensorParameter(changeKey);
