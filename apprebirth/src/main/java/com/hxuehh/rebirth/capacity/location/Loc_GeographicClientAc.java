...
public class Loc_GeographicClientAc extends BaseDeviceCapacityAc_2 {
    ...
    public MidMessageOrder_2 getCmdForChange(int changeKey) {
        ...
        if (changeKey == getStatus) {
            mDeviceCapacityParameter = new Loc_Geographic.Loc_GeographicParameter(changeKey, 0);
        } else if (changeKey == End) {
            mDeviceCapacityParameter = new Loc_Geographic.Loc_GeographicParameter(changeKey, 0);
        } else if (changeKey == ReSet) {
            mDeviceCapacityParameter = new Loc_Geographic.Loc_GeographicParameter(changeKey, 1000 * 60);
        }
