...
public class BatteryClientAc extends BaseDeviceCapacityAc_2 {
    ...
    public MidMessageOrder_2 getCmdForChange(int changeKey) {
        DeviceCapacityInParameter mDeviceCapacityParameter = new Battery.BatteryParameter(true);
