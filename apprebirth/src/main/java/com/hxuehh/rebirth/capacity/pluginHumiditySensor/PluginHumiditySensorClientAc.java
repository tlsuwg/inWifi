...
public class PluginHumiditySensorClientAc extends BaseDeviceCapacityAc_2 {

    @Override
    public int getViewKey() {
        return ViewKeys.PluginHumiditySensorClientAc;
    }
    ...
    public MidMessageOrder_2 getCmdForChange(int changeKey) {
        ...
        DeviceCapacityInParameter mDeviceCapacityParameter = new PluginHumiditySensor.PluginHumiditySensorParameter(changeKey);
