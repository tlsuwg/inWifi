...
public class TemperatureClientAc extends BaseDeviceCapacityAc_2 {
    ...
    public MidMessageOrder_2 getCmdForChange(int changeKey) {
        DeviceCapacityInParameter mDeviceCapacityParameter = new Temperature.TemperatureParameter(true);
