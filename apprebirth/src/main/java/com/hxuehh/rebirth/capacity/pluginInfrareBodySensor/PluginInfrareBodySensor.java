 ...
 */
public class PluginInfrareBodySensor extends DeviceCapacitySensorBase {
    ...
    public PluginInfrareBodySensor(Scene mScene) {
        this.mScene = mScene;
    }
    ...
    @Override
    public int getType() {
        return DeviceCapacityBase.Type_Add_PluginInfraredBody;
    }
    ...
    public DeviceCapacityOutResult_3 doChangeStatus(DeviceCapacityInParameter t) throws FaceException {
        ...
        if (!(t instanceof InfrareBodySensorParameter)) throw new FaceException("参数类型出错");
        final InfrareBodySensorParameter tt = (InfrareBodySensorParameter) t;
        CommonDeviceCapacityOutResult commonDeviceCapacityOutResult = new CommonDeviceCapacityOutResult(true);
        if (tt.getType() == InfrareBodySensorParameter.TypeGetStatus) {
    ...
    public int getMAXHistorySize() {
        return DeviceCapacitySetting.InfrareBodySensor_his_max;
    }
    ...
    public void OnItemClickListener(FaceBaseActivity_1 mContext, View view, int position, Object allData, LoadCursorSetting mLoadCursorSetting, Object[] t) throws RemoteException, FaceException {
        ...
        IntentChangeManger.jumpTo(mContext, IntentChangeManger.flag_infrare_body_sensor_ac, false);
    }
    ...
    @Face_UnsolvedForDlp
    public static class InfrareBodySensorParameter extends DeviceCapacityInParameter implements Serializable {
        public static final int TypeGetStatus = 1;

        public InfrareBodySensorParameter(int type) {
            super(type);
        }
    }
