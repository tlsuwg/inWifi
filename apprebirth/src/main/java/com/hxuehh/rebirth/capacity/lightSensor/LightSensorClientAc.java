...
public class LightSensorClientAc extends BaseDeviceCapacityAc_2 {

    @Override
    public int getViewKey() {
        return ViewKeys.TemperatureClientAc;
    }
    ...
    public void setMainView() {
        ...
        String names[] = new String[]{"查看光感状态", "配置：调整光强度底部阀值", "启用", "失效"};
        int keys[] = new int[]{LightSensor.TemperatureParameter.TypeGetStatus, LightSensor.TemperatureParameter.TypeSetMin,
                LightSensor.TemperatureParameter.Type_SetDeviceCapacityBaseSenserUsed_1,
                LightSensor.TemperatureParameter.Type_SetDeviceCapacityBaseSenserUsed_0
        };
    ...
    public MidMessageOrder_2 getCmdForChange(int changeKey) {
        ...
        DeviceCapacityInParameter mDeviceCapacityParameter = new LightSensor.TemperatureParameter(changeKey, min);
