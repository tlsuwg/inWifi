package com.hxuehh.rebirth.capacity.pluginHumiditySensor;
 ...
 */
public class PluginHumiditySensor extends DeviceCapacitySensorBase {
    ...
    public PluginHumiditySensor(Scene mScene) {
        this.mScene = mScene;
    }
...
//        callBack();
    ...
    @Override
    public int getType() {
        return DeviceCapacityBase.Type_Add_Pluginy_Humidity;
    }
    ...
    public DeviceCapacityOutResult_3 doChangeStatus(DeviceCapacityInParameter t) throws FaceException {
        ...
        if (!(t instanceof PluginHumiditySensorParameter)) throw new FaceException("参数类型出错");
        final PluginHumiditySensorParameter tt = (PluginHumiditySensorParameter) t;
        CommonDeviceCapacityOutResult commonDeviceCapacityOutResult = new CommonDeviceCapacityOutResult(true);
        if (tt.getType() == PluginHumiditySensorParameter.TypeGetStatus) {
    ...
    public int getMAXHistorySize() {
        return DeviceCapacitySetting.PluginHumiditySensor_his_max;
    }
    ...
    public void OnItemClickListener(FaceBaseActivity_1 mContext, View view, int position, Object allData, LoadCursorSetting mLoadCursorSetting, Object[] t) throws RemoteException, FaceException {
        ...
        IntentChangeManger.jumpTo(mContext, IntentChangeManger.flag_add_humidity_sensor_ac, false);
    }
    ...
    @Face_UnsolvedForDlp
    public static class PluginHumiditySensorParameter extends DeviceCapacityInParameter implements Serializable {
        public static final int TypeGetStatus = 1;
        public PluginHumiditySensorParameter(int type) {
            super(type);
        }
    }
