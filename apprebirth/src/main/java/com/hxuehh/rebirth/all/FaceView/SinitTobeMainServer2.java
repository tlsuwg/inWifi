 ...
 */
public class SinitTobeMainServer2 extends FaceGetMainViewImp implements ProViewForStep {

    public SinitTobeMainServer2(FaceContextWrapImp context, int Viewkey) {
    ...
    @Override
    public void onErr() {
        mProView.setErrorInfo("启动失败，请清理Android进程重试");
    }
