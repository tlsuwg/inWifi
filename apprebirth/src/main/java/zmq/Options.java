...
public class Options
{
    ...
    // The timeout for sendSyncAddCache/recv operations for this socket.
    int recvTimeout;
    int sendTimeout;
    ...
    //  If 1, connecting pipes are not attached immediately, meaning a sendSyncAddCache()
    //  on a socket with only connecting pipes would block
    int delayAttachOnConnect;

    //  If true, session reads all the pending messages from the pipe and
    //  sends them to the network when socket is close.
    ...
    final List<TcpAddressMask> tcpAcceptFilters;
    ...
    public Options()
    {
        ...
        identity = null;
        tcpAcceptFilters = new ArrayList<TcpAddressMask>();
        decoder = null;
        encoder = null;
    }
