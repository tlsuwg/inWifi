...
class Dist
{
    ...
    //  Number of all the pipes to sendSyncAddCache the next message to.
    ...
    //  the active pipes plus all the pipes that we can in theory sendSyncAddCache
    ...
    //  will sendSyncAddCache message also to this pipe.
