...
class Pipe extends ZObject
{
    ...
    //  Sink to sendSyncAddCache events to.
    ...
    //  Specifies the object to sendSyncAddCache events to.
    ...
    protected void processPipeTerm()
    {
        ...
        //  This is the case where both ends of the pipe are close in parallel.
    ...
    public void terminate(boolean delay)
    {
        ...
        //  close anyway. No need to do anything special here.
