    ...
    implements IPollEvents, Pipe.IPipeEvents
{
    ...
    private void attachPipe(Pipe pipe, boolean icanhasall)
    {
        ...
        //  If the socket is already being close, ask any new pipes to terminate
        //  straight away.
        if (isTerminating()) {
            registerTermAcks(1);
    ...
    public boolean connect(String addr)
    {
        ...
        if (protocol.equals("inproc")) {
            ...
            //  If required, sendSyncAddCache the identity of the peer to the local socket.
            ...
            //  If required, sendSyncAddCache the identity of the local socket to the peer.
    ...
    public boolean send(Msg msg, int flags)
    {
        ...
        //  Try to sendSyncAddCache the message.
        ...
        //  In case of non-blocking sendSyncAddCache we'll simply propagate
        ...
        //  Oops, we couldn't sendSyncAddCache the message. Wait for the next
        //  command, process it and try to sendSyncAddCache the message again.
    ...
    public Msg recv(int flags)
    {
        ...
        //  described above) from the one used by 'sendSyncAddCache'. This is because counting
