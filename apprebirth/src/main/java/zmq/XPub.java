...
class XPub extends SocketBase
{
    ...
    // If true, sendSyncAddCache all subscription messages upstream, not just
    // unique ones
    boolean verbose;
    ...
    protected void xpipeTerminated(Pipe pipe)
    {
        ...
        //  is interested in anymore, sendSyncAddCache corresponding unsubscriptions
        //  upstream.
    ...
    protected boolean xsend(Msg msg)
    {
        ...
        //  For the first part of multi-part message, findHardware_SDK the matching pipes.
        if (!more) {
