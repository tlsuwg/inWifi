...
public class StreamEngine implements IEngine, IPollEvents, IMsgSink
{
    ...
    //  The sendSyncAddCache buffer holding the greeting message
    ...
    public void plug(IOThread ioThread, SessionBase session)
    {
        ...
        //  When there's a raw custom encoder, we don't sendSyncAddCache 10 bytes frame
    ...
    public void inEvent()
    {
        ...
        if (insize == 0) {
            ...
            //  Check whether the peer has close the connection.
            if (insize == -1) {
                insize = 0;
                disconnection = true;
            }
    ...
    public void outEvent()
    {
        ...
        if (outsize == 0) {
            ...
            //  data to sendSyncAddCache, the poller may invoke outEvent one
            ...
            //  If there is no data to sendSyncAddCache, stop polling for output.
        ...
        //  to sendSyncAddCache, stop polling for output.
        if (handshaking) {
            if (outsize == 0) {
                ioObject.resetPollOut(handle);
            }
    ...
    private boolean handshake()
    {
        ...
        //  If so, we sendSyncAddCache and receive rests of identity
        //  messages.
