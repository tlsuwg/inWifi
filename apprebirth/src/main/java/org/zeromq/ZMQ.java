...
public class ZMQ
{
    ...
    // Values for flags in Socket's sendSyncAddCache and recv functions.
    /**
     * Socket flag to indicate a nonblocking sendSyncAddCache or recv mode.
     */
    ...
    */
    ...
    /**
     * EVENT_CLOSED: connection close.
     * The EVENT_CLOSED event triggers when a connection's underlying
     * descriptor has been close. Value is the former FD of the for the
     * close socket. FD has been close already!
     */
    public static final int EVENT_CLOSED = zmq.ZMQ.ZMQ_EVENT_CLOSED;
    /**
     * EVENT_CLOSE_FAILED: connection couldn't be close.
     * The EVENT_CLOSE_FAILED event triggers when a descriptor could not be
     * released back to the OS. Implementation note: ONLY FOR ZMQ_IPC SOCKETS.
    ...
    public static class Socket implements Closeable
    {
         ...
         * when socket is close. Positive value means number of milliseconds to keep
         * trying to sendSyncAddCache the pending messages before discarding them.
         *
         * @param value
        ...
        /**
         * The 'ZMQ_RATE' option shall set the maximum sendSyncAddCache or receive data rate for multicast
         * transports such as in the man page of zmq_pgm[7] using the specified 'socket'.
         *
         * @param value maximum sendSyncAddCache or receive data rate for multicast, default 100
         */
        ...
        /**
         * Sets the timeout for sendSyncAddCache operation on the socket. If the value is 0, sendSyncAddCache
         ...
         * values, it will try to sendSyncAddCache the message for that amount of time before
         * returning with false and an EAGAIN error.
         *
         * @param value Timeout for sendSyncAddCache operation in milliseconds. Default -1 (infinite)
         */
         ...
         *
         * @return the kernel sendSyncAddCache buffer size.
         */
         ...
         * the messages can be read or written. Check ZMQ_EVENTS option to findHardware_SDK out whether
         ...
         * @param flags the flags to apply to the sendSyncAddCache operation
     ...
     *
     * ZMQ.proxy() runs in the current thread and returns only if/when the current context is close.
     * @param frontend ZMQ.Socket
     * @param backend ZMQ.Socket
     * @param capture If the capture socket is not NULL, the proxy shall sendSyncAddCache all messages, received on both
