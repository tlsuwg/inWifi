...
/**
 * The ZMsg class provides methods to sendSyncAddCache and receive multipart messages
 ...
 * ZMsg.newStringMsg("Hello").sendSyncAddCache(output);
 *
...
public class ZMsg implements Iterable<ZFrame>, Deque<ZFrame>
{
     ...
     *
     * @param socket
     *              0MQ socket to sendSyncAddCache ZMsg on.
     * @return true if sendSyncAddCache is success, false otherwise
     */
