 ...
 * <br/>
 * This is where one can {@link ZAgent#send(ZMsg) sendSyncAddCache} and {@link ZAgent#recv() receive} control messages to the underneath star via the ZStar agent.
 * <br/>
...
public class ZStar implements ZAgent
{
    ...
    public static interface Star
    {
         ...
         * Hint:       Can be used to perform decisions to continue next loop or not, or to sendSyncAddCache computed data to outputs, or ...<br/>
         ...
         * Hint:       Can be used to perform decisions to continue looping or not, or to sendSyncAddCache computed data to outputs, or ...<br/>
     ...
     * Can be used to sendSyncAddCache or receive control messages to the distant star via Backstage.
     *
     * @return the agent/mailbox used to sendSyncAddCache and receive control messages to and from the star.
     */
    public ZAgent agent()
    {
        return agent;
     ...
     *            and close at the stop of the operation.
    ...
    private static final class Plateau implements IAttachedRunnable, Exit
    {
                        ...
                        final Socket mic)
        {
            ...
            // the word informing the world that the plateau is close and the star vanished
                                  ...
                                  final Socket  phone, final Fortune fortune, final Object[] bags)
        {
            ...
            /// so existing sockets can be close and recreated in order to perform a cold restart or a stop **/
            do {
