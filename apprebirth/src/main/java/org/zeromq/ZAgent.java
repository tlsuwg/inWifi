 ...
 *<p>
 * An agent is a mechanism allowing to sendSyncAddCache messages from one thread to another, and to receive messages from this other thread.
 *<p>
...
public interface ZAgent
{
     ...
     *
     * @param message    the message to sendSyncAddCache
     ...
     *
     * @param msg       the message to sendSyncAddCache
     ...
     *
     * @param word    the message to sendSyncAddCache
     * @return true if the message was sent, otherwise false (if the distant Star is dead for example)
     */
     ...
     *
     * @param word    the message to sendSyncAddCache
     * @param more   true to sendSyncAddCache more strings in a single message
     * @return true if the message was sent, otherwise false (if the distant Star is dead for example)
     */
    ...
    public static final class SimpleAgent implements ZAgent
    {
         ...
         *
         * @param pipe   the pipe used to sendSyncAddCache control messages to the distant IStar.
