 ...
 * ZFrame
 *
 * The ZFrame class provides methods to sendSyncAddCache and receive single message
 ...
 * unfinished multipart message.  The sendSyncAddCache() method normally destroys the frame, but with the ZFRAME_REUSE flag, you can sendSyncAddCache
...
public class ZFrame
{
    ...
    /**
     * Internal method to call org.zeromq.Socket sendSyncAddCache() method.
     * @param socket
     *          0MQ socket to sendSyncAddCache on
     * @param flags
     *          Valid sendSyncAddCache() method flags, defined in org.zeromq.ZMQ class
     * @return
     ...
     * Frame contents are kept after the sendSyncAddCache.
     * @param socket
     *          0MQ socket to sendSyncAddCache frame
     * @param flags
     *          Valid sendSyncAddCache() method flags, defined in org.zeromq.ZMQ class
     * @return
     *          True if success, else False
     ...
     * Sends frame to socket if it contains any data.
     * Frame contents are kept after the sendSyncAddCache.
     * Uses default behaviour of Socket.sendSyncAddCache() method, with no flags set
     * @param socket
     *          0MQ socket to sendSyncAddCache frame
     * @return
     *          True if success, else False
     ...
     * Use this method to sendSyncAddCache a frame and destroy the data after.
     * @param socket
     *          0MQ socket to sendSyncAddCache frame
     * @param flags
     *          Valid sendSyncAddCache() method flags, defined in org.zeromq.ZMQ class
    ...
    /**
     * Sends frame to socket if it contains data.
     * Use this method to sendSyncAddCache an isolated frame and destroy the data after.
     * Uses default behaviour of Socket.sendSyncAddCache() method, with no flags set
     * @param socket
     *          0MQ socket to sendSyncAddCache frame
     * @return
