...
public class ZProxy
{
    ...
    public static interface Proxy
    {
         ...
         *
         * Note: you need to sendSyncAddCache one (1) mandatory custom response message with the pipe before the end of this call.
         *
         ...
         *
         * Note: you need to sendSyncAddCache the current state at the end of the call.
         *
         * @param pipe      the control pipe
     ...
     * The distant side has to sendSyncAddCache back one (1) mandatory response message.
     *
     ...
     * If null, a new context will be created and close at the stop of the operation.
    ...
    public static interface Pump
    {
         ...
         * @param capture       the optional sockets where to sendSyncAddCache the message to. Possibly null.
         * @param dst           the plug of the destination socket
         * @param destination   the socket where to sendSyncAddCache the message to.
         *
...
//                boolean destroy = !msg.equals(cpt); // TODO ?? which one
                ...
                if (!success) {
                    // not successful, but we can still try to sendSyncAddCache it to the destination
                }
            }

            ZMsg dst = transformer.transform(msg, splug, dplug);
            // we sendSyncAddCache the whole transformed message
     ...
     * that will sendSyncAddCache each packets individually instead of the whole message.
     */
    private static final class ZmqPump implements Pump
    {
                ...
                Plug dplug, Socket destination)
        {
            ...
            while (true) {
                ...
                // we sendSyncAddCache the packet
