...
//下拉刷新
public abstract class PullToRefreshBase_1_brand<T extends View> extends LinearLayout {
    ...
    public PullToRefreshBase_1_brand(Context context) {
        super(context);
        init(context, null);
    }

    public PullToRefreshBase_1_brand(Context context, int mode) {
        super(context);
        this.mode = mode;
        init(context, null);
    }

    public PullToRefreshBase_1_brand(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
...
//        if (footerLayout != null) footerLayout.setPullRefreshTime(updateAt.toString());
    ...
    protected abstract void dumpGone(boolean isGone);
