...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    protected StickyGridHeadersBaseAdapterWrapper3 mAdapter;
...
/*
        ...
        //this.mAdapter = new StickyGridHeadersBaseAdapterWrapper(getFaceContext(), this, baseAdapter);
        this.mAdapter=(StickyGridHeadersBaseAdapterWrapper3) adapter;
      /*  TextView v=new TextView(context);
        v.setText("ybj");
        mAdapter.addHeader(v);*/
    ...
    private void scrollChanged(int firstVisibleItem) {
        ...
        if(mAdapter.getIsHasHeader()){
            if(firstVisibleItem<mNumMeasuredColumns){
                //mAreHeadersSticky=false;
                mHeaderBottomPosition = 0;
                return;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        for (int i = 0; i < headerPositions.size(); i++) {
            ...
            boolean headerIsStickied = ((StickyGridHeadersBaseAdapterWrapper3.HeaderFillerView)frame).getHeaderId() == mCurrentHeaderId
