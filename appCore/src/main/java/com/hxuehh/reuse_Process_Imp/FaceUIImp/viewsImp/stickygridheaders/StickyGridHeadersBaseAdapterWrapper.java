...
//private View footerview=null;
  ...
  /*  public void addHeader(View view1){
    	footerview=view1;
    }*/
    @Override
    public int getCount() {
       ...
       /* if(footerview!=null){
        ...
        for (int i = 0; i < numHeaders; i++) {
            ...
            // group.\
        	/*if(i==numHeaders-1&&footerview!=null){
        		 mCount += mNumColumns;
        	}
        	else{*/
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (adapterPosition.mPosition == POSITION_HEADER) {
            ...
            view = mDelegate.getHeaderView(adapterPosition.mHeader, (View)v.getTag(), parent);
          ...
          /* if(((getCount()-mNumColumns)<=position)&&position<getCount()&&footer){
            	view = mDelegate.getFooterView(adapterPosition.mHeader, (View)v.getTag(), parent);
            }
            else{
            	  view = mDelegate.getHeaderView(adapterPosition.mHeader, (View)v.getTag(), parent);
