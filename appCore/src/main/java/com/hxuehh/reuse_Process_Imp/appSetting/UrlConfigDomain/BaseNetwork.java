...
public class BaseNetwork {
    ...
    // 分类 v3.6.3全部升级成v4
    //public String CATEGORY_DEAL_URL = "";
    ...
    // 根据ids获取deal列表V2 增加主题馆品牌团优品会的判断字段
    ...
    public String ZHI_CATEGORY_URL = "";//获取所有
    ...
    // 获取用户推荐IDs
    public String LOAD_USER_LIKE_IDS = "";
    ...
    //    public static final String Host = "im.xiongmaoz.com";
...
//    品牌团顶部设置
    ...
    public String getFaceCollection() {
        return BASE_API + "dressroom/collection";
    }

    //虚拟试衣 主题列表
    public String getFaceCollectionDeals() {
        return BASE_API + "dressroom/collection/deals";
    }
    ...
    //
    public String SIGN_IS_NEED_REVIVAL = "";// 签到复活接口地址

    public String INVITE_FRIEND="";//邀请好友
    ...
    public String shiftserverelation="";//邀请好友
    ...
    public String GET_TELCHARGE_EXCHANGESCORE;//积分抵话费规则
    public String GET_TELCHARGE_TEXT;//积分抵话费文案
    public String GET_TELCHARGE_ORDER;//积分抵话费订单
    public String GET_TELCHARGE_ISJOIN;//是否参加积分抵话费
    public String GET_TELCHARGE_RULE;//抵话费
