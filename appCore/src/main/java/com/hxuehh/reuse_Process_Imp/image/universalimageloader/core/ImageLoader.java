...
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.assist.ImageSize;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.assist.LoadedFrom;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.assist.SimpleImageLoadingListener;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.display.FakeBitmapDisplayer;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.utils.ImageSizeUtils;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.utils.L;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.assist.FailReason;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.assist.FlushedInputStream;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.assist.MemoryCacheUtil;
...
public class ImageLoader {
	...
	private static final String WARNING_RE_INIT_CONFIG = "Try to initialize ImageLoader which had already been initialized before. "
			+ "To re-select_device_type ImageLoader with new configuration call ImageLoader.destroy() at first.";
	private static final String ERROR_WRONG_ARGUMENTS = "Wrong arguments were passed to displayImage() method (ImageView reference must not be null)";
	private static final String ERROR_NOT_INIT = "ImageLoader must be select_device_type with configuration before using";
	 ...
	 */
	public void displayImage(DealUrl uri, ImageView imageView) {
...
//	}
    ...
    public void displayImage(DealUrl uri, ImageView imageView, DisplayImageOptions options) {
        displayImage(uri, imageView, options, null);
    }
	 ...
	 * @throws IllegalArgumentException if passed <b>imageView</b> is null
	 */
	public void displayImage(DealUrl uri, ImageView imageView, ImageLoadingListener listener) {
    ...
    public void displayImage(DealUrl uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener) {
        ...
        if (bmp != null && !bmp.isRecycled()) {
            ...
            if (options.shouldPostProcess()) {
                ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri, imageView, targetSize, memoryCacheKey, options, listener, engine.getLockForUri(uri.url));
                ...
                listener.onLoadingComplete(uri.url, imageView, bmp);
            }
        } else {
    ...
    public void displayImage(DealUrl uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener, int from) {
        checkConfiguration();
        if (imageView == null) {
            throw new IllegalArgumentException(ERROR_WRONG_ARGUMENTS);
        }
        ...
        if (uri == null) {
            ...
            Image13lLoader.getInstance().onLoadingComplete(uri.url, imageView, null, from);
            return;
        }
...
//                listener.onLoadingComplete(uri.url, imageView, bmp);
	 ...
	 * {@link ImageLoadingListener#onLoadingComplete(String, android.view.View, Bitmap)} callback}.<br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri      Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param listener {@linkplain ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(DealUrl uri, ImageLoadingListener listener) {
	 ...
	 *                     {@linkplain ImageLoadingListener#onLoadingComplete(String, android.view.View, Bitmap)} callback}. Downloaded image will be decoded
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(DealUrl uri, ImageSize minImageSize, ImageLoadingListener listener) {
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(DealUrl uri, DisplayImageOptions options, ImageLoadingListener listener) {
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(DealUrl uri, ImageSize targetImageSize, DisplayImageOptions options, ImageLoadingListener listener) {
		checkConfiguration();
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public MemoryCacheAware_0<String, Bitmap> getMemoryCache() {
		checkConfiguration();
	 ...
	 * You can {@linkplain #init(ImageLoaderConfiguration) select_device_type} ImageLoader with new configuration after calling this
	 * method.
	 */
	public void destroy() {
