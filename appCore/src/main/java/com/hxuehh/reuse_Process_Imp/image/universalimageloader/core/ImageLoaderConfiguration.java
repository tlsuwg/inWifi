...
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.process.BitmapProcessor;
...
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.download.NetworkDeniedImageDownloader;
import com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.download.SlowNetworkImageDownloader;
 ...
 * @since 1.0.0
 * @see ImageLoader
 * @see MemoryCacheAware_0
 * @see com.hxuehh.reuse_Process_Imp.image.universalimageloader.cache.disc.DiscCacheAware
...
public final class ImageLoaderConfiguration {
	...
	final MemoryCacheAware_0<String, Bitmap> memoryCache;
	...
	public static class Builder {
		...
		private MemoryCacheAware_0<String, Bitmap> memoryCache = null;
		 ...
		 * {@link com.hxuehh.reuse_Process_Imp.image.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 * memory cache. You can use {@link #memoryCache(MemoryCacheAware_0)} method to set your own implementation of
		 * {@link MemoryCacheAware_0}.
		 */
		 ...
		 * Default value - {@link com.hxuehh.reuse_Process_Imp.image.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * </ul>
		 */
		public Builder memoryCache(MemoryCacheAware_0<String, Bitmap> memoryCache) {
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.hxuehh.reuse_Process_Imp.image.universalimageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.hxuehh.reuse_Process_Imp.image.universalimageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value - {@link com.hxuehh.reuse_Process_Imp.image.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.hxuehh.reuse_Process_Imp.image.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		...
		private void initEmptyFiledsWithDefaultValues() {
			if (taskExecutor == null) {
				taskExecutor = DefaultConfigurationFactory.createExecutor(threadPoolSize, threadPriority, tasksProcessingType,"taskExecutor");
			} else {
				customExecutor = true;
			}
			if (taskExecutorForCachedImages == null) {
				taskExecutorForCachedImages = DefaultConfigurationFactory.createExecutor(threadPoolSize, threadPriority, tasksProcessingType,"taskExecutorForCachedImages");
			} else {
