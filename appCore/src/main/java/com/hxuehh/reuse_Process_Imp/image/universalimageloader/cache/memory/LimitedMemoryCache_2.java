 ...
 *******************************************************************************/
package com.hxuehh.reuse_Process_Imp.image.universalimageloader.cache.memory;
 ...
 * @see BaseMemoryCache_1
 * @since 1.0.0
 */
//有限制的
public abstract class LimitedMemoryCache_2<K, V> extends BaseMemoryCache_1<K, V> {
	...
	public LimitedMemoryCache_2(int sizeLimit) {
