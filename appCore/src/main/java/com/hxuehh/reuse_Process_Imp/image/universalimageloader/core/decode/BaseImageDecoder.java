 ...
 *******************************************************************************/
package com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.decode;
...
import com.hxuehh.reuse_Process_Imp.staicUtil.commonUtil.ImgUtil;
...
//            if (WebPFactory.isWebP(picBytes)){
//                if(MappingDeviceInfo_ShortCut.isMIUI() || !ApiUtil.hasIceCremSandwich()){//MIUI 或 4.0以下 //华为C8812  4.0.3 decodeByteArray 直接返回空
...
//            return BitmapFactory.decodeByteArray(picBytes, 0, byteOut.size(), decodingOptions);
            ...
            boolean bWebP = WebPFactory.isWebP(picBytes);
            if (bWebP && DeviceUtil.isMIUI()) {
                return ImgUtil.getWebpBitmap(picBytes);
            }
