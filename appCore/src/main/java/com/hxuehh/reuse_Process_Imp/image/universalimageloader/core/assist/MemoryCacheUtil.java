...
public final class MemoryCacheUtil {
	 ...
	 * {@link com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.ImageLoaderConfiguration.Builder#denyCacheImageMultipleSizesInMemory()
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.ImageLoaderConfiguration configuration}
	 */
	public static List<Bitmap> findCachedBitmapsForImageUri(String imageUri, MemoryCacheAware_0<String, Bitmap> memoryCache) {
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.ImageLoaderConfiguration configuration}
	 */
	public static List<String> findCacheKeysForImageUri(String imageUri, MemoryCacheAware_0<String, Bitmap> memoryCache) {
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.ImageLoaderConfiguration configuration}
	 */
	public static void removeFromCache(String imageUri, MemoryCacheAware_0<String, Bitmap> memoryCache) {
