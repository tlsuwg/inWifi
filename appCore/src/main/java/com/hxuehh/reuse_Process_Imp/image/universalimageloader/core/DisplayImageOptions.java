...
public final class DisplayImageOptions {
	...
	public static class Builder {
		...
		public Builder() {
			...
			decodingOptions.inInputShareable = false;
		}
		...
		/**
		 * Sets custom {@linkplain Handler handler} for displaying images and firing {@linkplain com.hxuehh.reuse_Process_Imp.image.universalimageloader.core.assist.ImageLoadingListener
		 * listener} events.
		 */
