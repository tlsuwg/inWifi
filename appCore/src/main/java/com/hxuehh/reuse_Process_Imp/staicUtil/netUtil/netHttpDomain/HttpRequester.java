...
public class HttpRequester {
    ...
    private void addUserAgent(HttpUriRequest request) {
        ...
        sb.append(AppConfig.getInstance().CLIENT_TAG)
          .append("|")
          .append(DeviceUtil.getimei())
          .append("|")
          .append("Android")
          .append("|")
          .append(SuApplication.getInstance().getVersionName())
          .append("|")
    ...
    private void addMultipartEntityToHttpPost(HttpPost m, Map<String, Object> params) throws UnsupportedEncodingException{
        ...
        for (Map.Entry<String, Object> entry : params.entrySet()) {
            if (entry.getValue() instanceof String) {
                ...
                stringPar = new StringBody((String) entry.getValue(), Charset.forName(HTTP.UTF_8));
